 ...
 */
function truss_customize_register( $wp_customize ) {
    $wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
    $wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
    $wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
}
add_action( 'customize_register', 'truss_customize_register' );
    ...
    $wp_customize->add_section('neat_theme_addons' , array(
        ...
        $wp_customize->add_control(
            new WP_Customize_Control(
                ...
                array(
                    'label'     => __('Enable Fontawesome Icons', 'truss'),
        ...
        $wp_customize->add_control(
            new WP_Customize_Control(
                ...
                array(
                    'label'     => __('Enable Genericon Icons', 'truss'),
                    'section'   => 'neat_theme_addons',
...
function truss_customize_preview_js() {
    wp_enqueue_script( 'truss_customizer', get_template_directory_uri() . '/library/assets/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
add_action( 'customize_preview_init', 'truss_customize_preview_js' );